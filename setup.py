...
EXTENSIONS_TO_BUILD = [Extension("MeshAdaptPUMI.MeshAdaptPUMI",
              ...
              Extension('cmeshTools',
                        ['proteus/cmeshToolsModule.cpp','proteus/mesh.cpp','proteus/meshio.cpp','proteus/msu/msu_mesh_util.cpp','proteus/msu/mesh_msu.cpp'],
                        define_macros=[('PROTEUS_SUPERLU_H',PROTEUS_SUPERLU_H),
                                       ('PROTEUS_TRIANGLE_H',PROTEUS_TRIANGLE_H)],
                        include_dirs=([numpy.get_include(),'proteus']+
                                      [PROTEUS_TRIANGLE_INCLUDE_DIR]),
                        libraries=['m','ann',PROTEUS_DAETK_LIB]+[PROTEUS_TRIANGLE_LIB],
              ...
              Extension('flcbdfWrappers',
                        ['proteus/flcbdfWrappersModule.cpp','proteus/mesh.cpp','proteus/meshio.cpp','proteus/msu/msu_mesh_util.cpp','proteus/msu/mesh_msu.cpp'],
                        ...
                        libraries=['hdf5','stdc++','m','ann',PROTEUS_DAETK_LIB]+PROTEUS_PETSC_LIBS+PROTEUS_MPI_LIBS+PROTEUS_HDF5_LIBS,
